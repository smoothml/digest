...
date = "2026-06-17"
draft = false
title = "Lords Advance Social Housing Bill Amid Thames Water Scrutiny"
tags = [
    "housing",
    "healthcare",
    "onlinesafety",
...
Ministers explained the repeal of never‑commenced powers to force sale of higher‑value vacant council homes, as the policy would have harmed local spending plans and delivered a net loss of social housing. They also repealed uncommenced provisions to require most new secure tenancies to be fixed‑term, stating: “we want to make it clear that we support lifetime tenancies” while allowing fixed terms in specific schemes. 
A proposal to re‑enable higher rents for higher‑income tenants (‘pay‑to‑stay’) was rejected; the 2016 powers “were never implemented,” with discretionary approaches available. On anti‑social behaviour, the Minister cited strengthened powers and shorter notice for the mandatory ASB ground under the Renters’ Rights Act. Outcomes: Clauses 14–16 agreed; probing amendments not moved.
