...
from digest.sources.hansard.constants import BASE_URL, FILE_PREFIXES, Source
...
class HansardDataExtractor:
    """Hansard data extractor class.
    ...
    def _get_content(self, dt: date, source: Source) -> str:
...
def get_hansard_data_extractor() -> HansardDataExtractor:
    return HansardDataExtractor()
